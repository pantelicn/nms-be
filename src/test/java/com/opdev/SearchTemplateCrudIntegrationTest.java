...
public class SearchTemplateCrudIntegrationTest extends AbstractIntegrationTest {
    ...
    public void searchTemplateCrud() {
        ...
        SearchTemplateAddDto javaDeveloperTemplate = new SearchTemplateAddDto("Senior java developer", facets, 5, List.of());
        ...
        SearchTemplateEditDto javaDeveloperTemplateEdit = new SearchTemplateEditDto(javaDevTemplateBody.getId(), "Senior java developer for SH", 5, List.of(), facetEdits);
